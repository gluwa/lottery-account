...
describe('Gluwacoin', function () {
  ...
  it('do drawing and award winner with large number of participant', async function () {
    ...
    console.info(await prizeLinkedAccountVault.getDrawWinner(drawDate));
    console.info(await prizeLinkedAccountVault.findMinMaxForDraw(drawDate));
